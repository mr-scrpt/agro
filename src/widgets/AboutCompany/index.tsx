...
export const AboutCompany: React.FC = () => {
  return (
    <Section id="about" className="bg-gray-50">
      <Container>
        <h2 className="text-3xl font-bold mb-6 text-center border-b-2 border-ukraine-yellow pb-2 inline-block mx-auto">
          Про компанію
        </h2>
        <div className="md:flex items-center gap-8 mt-10">
          ...
          <div className="md:w-1/2 relative h-64 md:h-80">
            <div className="absolute inset-0 bg-ukraine-blue rounded-lg overflow-hidden">
